    ...
    <>
      <header className="fixed left-0 right-0 top-0 z-50 px-4 pt-5 md:px-6">
        <div className="mx-auto w-full max-w-[1320px]">
          ...
          <div
            className={`mt-2 overflow-hidden rounded-2xl border border-white/60 bg-white/95 shadow-xl backdrop-blur-xl transition-all duration-300 lg:hidden ${isMobileMenuOpen ? "max-h-[400px] opacity-100" : "max-h-0 border-transparent opacity-0"
              }`}
          >
            <nav className="p-4">
