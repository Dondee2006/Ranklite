...
const articles = [
  {
    ...
    content: {
      ...
      image: 'https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/document-uploads/pexels-eva-bronzini-6956226-1765793402449.jpg?width=8000&height=8000&resize=contain',
    }
  },
  {
    id: 'threadpro',
              ...
              {articles.map((article, index) => (
                ...
                >
                  <button
                    ...
                    className={`group w-full text-left p-5 rounded-xl border transition-all duration-300 ease-in-out relative
